    ...
    <div class="container-fluid mx-5">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav ms-auto py-auto">      
          ...
          <a class="nav-link pe-5" href="/tentang"><img class="nav-pic pe-2" src="{{ asset('img/tentang.svg') }}" alt=""> Tentang Kami</a>    
          <a class="nav-link pe-5" href="/blog"><img class="nav-pic pe-2" src="{{ asset('img/blog.svg') }}" alt=""> Blog</a>    
          <a class="nav-link pe-5" href="/kontak"><img class="nav-pic pe-2" src="{{ asset('img/kontak.svg') }}" alt=""> Kontak</a>
